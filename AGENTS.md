...
- Dock visibility is a macOS presentation preference. Keep its typed config field cross-platform for portable configuration, but isolate native behavior behind the macOS adapter and preserve the Windows taskbar/icon path.
